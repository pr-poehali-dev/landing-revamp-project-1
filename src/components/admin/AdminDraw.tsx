...
const PRESET_PRIZES = [
  ...
  '📚 ЭДУКО — это центр развития навыков',
  ...
  '🏍️ Сертификат от компании МотоРом на 2 часа проката мотоцикла',
  '🎭 Компания SEDA: аренда поверхности на Театр оперы и балета «Сторона на мост»',
  '🎭 Компания SEDA: аренда поверхности на Театр оперы и балета «Сторона на мост»',
  '⚓ Компания SEDA: аренда поверхности на Морвокзале',
