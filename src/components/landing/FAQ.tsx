...
const faqs = [
  ...
  { q: 'Чем ПРЕМИУМ отличается от БАЗЫ?', a: 'Видеозапись всех блоков, расширенные материалы, первые ряды, закрытый чат с ведущими на месяц и двойной шанс в розыгрыше курса на 150 000 ₽.' },
