...
const faqs = [
  ...
  { q: 'Чем УЛЬТРА отличается от БАЗЫ?', a: 'Видеозапись всех блоков, расширенные материалы, первые ряды, закрытый чат с ведущими на месяц и двойной шанс в розыгрыше курса на 150 000 ₽.' },
  { q: 'Чем ПРЕМИУМ отличается от УЛЬТРЫ?', a: 'Бизнес Прожарка твоего бизнеса на сцене, личная консультация 30 минут, VIP-зона, мерч и сертификат. Мест строго ограничено.' },
  ...
  { q: 'Можно ли перенести билет? А что, если на сцене что-то не получится?', a: 'Билет переносится — напишите Дарье. А если на сцене что-то пойдёт не так — вы увидите, как это чинят вживую. В том и шоу без ширмы.' },
];
