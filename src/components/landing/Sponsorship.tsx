...
const tiers: Tier[] = [
  {
    ...
    features: [
      ...
      'Устное упоминание бренда ведущим Сергеем Черниковым минимум в 3 из 12 блоков программы',
      ...
      '10 билетов уровня УЛЬТРА или ПРЕМИУМ для сотрудников и клиентов',
    ],
    price: '500 000 ₽',
  ...
  },
  {
    ...
    features: [
      ...
      'Устное упоминание бренда ведущим в одном из 12 блоков программы',
      ...
      '5 билетов уровня БАЗА или УЛЬТРА для сотрудников и клиентов',
    ],
    price: '100 000 ₽',
