...
const cards = [
  ...
  { n: '11', title: 'Бизнес Прожарка LIVE', desc: 'Финал. Разбор бизнеса зрителя: рынок, конкуренты, точки роста, воронка с цифрами.', take: 'план роста своего бизнеса', chip: 'ПОД ПРОЖАРКУ — УЧАСТНИКИ VIP', time: '30:00' },
