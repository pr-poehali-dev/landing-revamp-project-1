...
const cards = [
  ...
  { n: '11', title: 'Бизнес Прожарка LIVE', desc: 'Финал. Разбор бизнеса зрителя: рынок, конкуренты, точки роста, воронка с цифрами.', take: 'план роста своего бизнеса', chip: 'ПОД ПРОЖАРКУ — УЧАСТНИКИ ПРЕМИУМ', time: '30:00' },
  { n: '12', title: 'Скрытый блок-сюрприз', desc: 'Про деньги и про то, что ИИ умеет уже сейчас.', take: 'узнаешь только в зале', chip: 'СЮРПРИЗ', surp: true, time: '??:??' },
];
      ...
      <div className="wrap">
        <div className="prog-head">
          <div>
            ...
            <h2 className="h2 rv">12 БЛОКОВ. КАЖДЫЙ —<br />ГОТОВЫЙ РЕЗУЛЬТАТ.</h2>
          </div>
